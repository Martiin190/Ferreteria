...
{
    public partial class VentanaDatosCuenta : Form
    {
        ...
        private void CampoUsuario_TextChanged_1(object sender, EventArgs e)
        {

        }

        private void CampoNombre_TextChanged_1(object sender, EventArgs e)
        {

        }

        private void CampoCon_TextChanged(object sender, EventArgs e)
        {

        }

        private void CampoConNueva_TextChanged(object sender, EventArgs e)
        {

        }

        private void CampoConCon_TextChanged(object sender, EventArgs e)
        {
